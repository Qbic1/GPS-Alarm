    ...
    public void autoCompleteSearch() {
        autocompleteFragment.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onError(Status status) {
                ...
                Toast.makeText(getApplicationContext(), "Не удалось выбрать место: " + status.getStatusMessage(),
...
//                        }
                        ...
                        nameEditText.setError("Название должно содержать не менее 4 символов.");
                    }
                }
            });
        }
            ...
            case REQUEST_CHECK_SETTINGS:
                switch (resultCode) {
                    ...
                    case Activity.RESULT_CANCELED:
                        ...
                        Toast.makeText(this, "Включите GPS для получения результата.", Toast.LENGTH_SHORT).show();
                        mRequestingLocationUpdates = false;
                        break;
                }
                break;
    ...
    public void onMyLocationClick(@NonNull Location location) {
        ...
        Toast.makeText(MapsActivity.this, "Точность: " + acc + " m\n" + Utils.getLocationCoordinate(location),
                Toast.LENGTH_SHORT).show();
    }
